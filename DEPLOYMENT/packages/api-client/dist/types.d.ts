...
export type AIInteractionType = 'vocabulary_lookup' | 'content_summary' | 'quiz_generation' | 'reading_assistance' | 'definition_explanation' | 'translation' | 'personalized_recommendation' | 'learning_analytics' | 'chat_assistance';
