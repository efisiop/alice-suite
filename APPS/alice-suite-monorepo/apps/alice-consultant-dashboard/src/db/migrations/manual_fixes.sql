-- Manual fixes for Alice Reader database schema issues
-- Run this script in the Supabase SQL Editor if the automatic fixes don't work
...
-- 7. Create get_tables function for diagnostics
...
GRANT EXECUTE ON FUNCTION get_book_by_string_id(TEXT) TO authenticated;

-- 8. Set up RLS policies for reading_stats
...
-- 9. Create necessary triggers to update timestamps
