    ...
    return (
      <Box sx={{ p: 3, textAlign: 'center' }}>
        ...
        <Typography variant="body2" color="text.secondary">
          This dashboard is only for authorized consultants.
        </Typography>
      </Box>
    );
  }
  ...
  return (
    <Fade in={visible} timeout={800}>
        ...
        {[
          {
            ...
            value: dashboardData.currentlyLoggedIn,
      ...
      <Slide direction="up" in={visible} timeout={800}>
        <Paper sx={{ mb: 3, borderRadius: 2, overflow: 'hidden', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          <Tabs
            value={tabValue}
