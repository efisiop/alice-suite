-- Fix Database Issues
-- This script fixes the missing tables and data format issues

-- 1. Create consultant_assignments table
CREATE TABLE IF NOT EXISTS consultant_assignments (
  ...
  book_id TEXT NOT NULL, -- Changed from UUID to TEXT to match existing data
...
-- 3. Create test profiles (if they don't exist)
