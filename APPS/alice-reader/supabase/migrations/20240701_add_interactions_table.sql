-- Migration: Add interactions table for comprehensive user activity logging
-- This script creates and configures the interactions table for tracking user activity
