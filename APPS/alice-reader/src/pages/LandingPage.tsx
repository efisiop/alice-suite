          ...
          <Grid container spacing={3} alignItems="center">
            ...
            <Grid item xs={12} md={8}>
              ...
              <Typography variant="body1" color="text.primary" sx={{ mb: 2 }}>
                Begin your journey down the rabbit hole with Alice! This interactive reading experience brings the classic tale to life with AI-powered assistance and vocabulary building tools.
              </Typography>
