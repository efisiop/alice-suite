...
import { sendActivity } from './services/activityLoggerService';
  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        sendActivity({ type: 'app_start', timestamp: new Date().toISOString() });
      ...
      <div className="App">
        ...
        <main id="main-content">
          <Routes>
            ...
            <Route path="/welcome" element={<RouteGuard routeType="auth"><WelcomePage /></RouteGuard>} />
