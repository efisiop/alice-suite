          ...
          <Card sx={{ opacity: readers.length === 0 ? 0.7 : 1 }}>
            <CardContent sx={{ py: 0.75 }}>
              ...
              <Typography variant="h6" sx={{ mb: 0.25 }}>
                {readers.length === 0 ? 0 : stats.totalReaders}
              </Typography>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ opacity: readers.length === 0 ? 0.7 : 1 }}>
            <CardContent sx={{ py: 0.75 }}>
              ...
              <Typography variant="h6" sx={{ mb: 0.25 }}>
                {readers.length === 0 ? 0 : stats.activeReaders}
              </Typography>
              <Typography variant="caption" color="text.secondary">
                Active in last 24h
              </Typography>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ opacity: readers.length === 0 ? 0.7 : 1 }}>
            <CardContent sx={{ py: 0.75 }}>
              ...
              <Typography variant="h6" sx={{ mb: 0.25 }}>
                {readers.length === 0 ? 0 : stats.recentInteractions}
              </Typography>
              <Typography variant="caption" color="text.secondary">
                Interactions today
              </Typography>
      ...
      <Paper sx={{ mb: 2 }}>
        ...
        <TabPanel value={tabValue} index={0}>
          ...
          <Box sx={{ mb: 2, display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            ...
            <FormControl size="small" sx={{ minWidth: 150 }} disabled={readers.length === 0}>
          ...
          {readers.length === 0 ? (
            <Box sx={{ textAlign: 'center', py: 8 }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Once readers start using the application, their activity will appear here for monitoring.
              </Typography>
              <Button 
                variant="outlined" 
            ...
            <Box sx={{ textAlign: 'center', py: 8 }}>
              ...
              <Typography variant="body1" color="text.secondary" gutterBottom>
                {searchQuery || eventTypeFilter 
                  ...
                  : 'There is no activity to display for your readers.'}
              </Typography>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                {searchQuery || eventTypeFilter 
                  ? 'Try adjusting your search terms or clearing filters.'
                  : 'Activity will appear here when readers interact with content.'}
              </Typography>
              <Button 
                variant="outlined" 
                onClick={() => {
        ...
        <TabPanel value={tabValue} index={1}>
          ...
          {readers.length === 0 ? (
            <Box sx={{ textAlign: 'center', py: 8 }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Once readers register and are verified, their status will appear here for monitoring.
              </Typography>
              <Button 
                variant="outlined" 
                onClick={handleRefresh}
        ...
        <TabPanel value={tabValue} index={2}>
          ...
          {readers.length === 0 ? (
            <Box sx={{ textAlign: 'center', py: 8 }}>
              ...
              <Typography variant="body1" color="text.secondary" gutterBottom>
                There are no readers to analyze engagement metrics for.
              </Typography>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Once readers register and start using the application, engagement metrics will be calculated and displayed here.
              </Typography>
              <Button 
                variant="outlined" 
                onClick={handleRefresh}
