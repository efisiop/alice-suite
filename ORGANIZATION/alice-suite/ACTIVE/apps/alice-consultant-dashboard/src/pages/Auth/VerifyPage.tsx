...
const VerifyPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!isFromRegistration && user && isVerified) {
      console.log('VerifyPage: User already verified, redirecting to consultant dashboard');
  ...
  useEffect(() => {
    if (isVerified && user) {
      console.log('VerifyPage: isVerified changed to true, redirecting to consultant dashboard');
      navigate('/', { replace: true });
    }
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('VerifyPage: Setting up redirect to consultant dashboard');
      setTimeout(() => {
        console.log('VerifyPage: Executing redirect to consultant dashboard');
        navigate('/', { replace: true });
      }, 1000);
